...
| Field | Value |
|---|---|
| **Current version name** | `DGO_R11_6_CONSOLIDATED_R3` |
| **Build artifact (path)** | `dgo-r11-6-consolidation-r3/DGO_R11_6_CONSOLIDATED_R3.zip` |
| **Embedded state.json** | `dgo-r11-6-consolidation-r3/DGO_R11_6_CONSOLIDATED_R3.state.json` (238 files, full content, no truncation; regenerates the package self-contained — round-trip byte-identical) |
| **Root folder inside zip** | `DGO_R11_6_CONSOLIDATED_R3/` |
...
| Artifact | Status |
|---|---|
| `dgo-r11-6-consolidation-r2/DGO_R11_6_CONSOLIDATED_R2.zip` | SUPERSEDED (previous current) |
